...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.oppinfo.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.coachinfo.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
...
def _get_struct_2f():
    ...
    return _struct_2f
_struct_3B4f2h3B2I4f4B = None
def _get_struct_3B4f2h3B2I4f4B():
    global _struct_3B4f2h3B2I4f4B
    if _struct_3B4f2h3B2I4f4B is None:
        _struct_3B4f2h3B2I4f4B = struct.Struct("<3B4f2h3B2I4f4B")
    return _struct_3B4f2h3B2I4f4B
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
