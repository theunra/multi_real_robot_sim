...
(cl:defmethod pass_cmd-val ((m <WorldModelInfo>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WorldModelInfo>)))
  ...
  "7d184d155b8f964299d2ae834875aebd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WorldModelInfo)))
  "Returns md5sum for a message object of type 'WorldModelInfo"
  "7d184d155b8f964299d2ae834875aebd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WorldModelInfo>)))
  ...
  (cl:format cl:nil "Header header~%ObstaclesInfo obstacleinfo~%ObstaclesInfo oppinfo~%RobotInfo[]   robotinfo~%BallInfo[]    ballinfo~%CoachInfo     coachinfo~%PassCommands  pass_cmd~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: nubot_common/ObstaclesInfo~%Header header~%Point2d[] pos~%PPoint[] polar_pos~%~%~%================================================================================~%MSG: nubot_common/Point2d~%float32 x~%float32 y~%~%================================================================================~%MSG: nubot_common/PPoint~%float32 angle~%float32 radius~%~%================================================================================~%MSG: nubot_common/RobotInfo~%Header header~%int32    AgentID~%int32    targetNum1~%int32    targetNum2~%int32    targetNum3~%int32    targetNum4~%int32    staticpassNum~%int32    staticcatchNum~%Point2d  pos~%Angle    heading~%float32  vrot~%Point2d  vtrans~%bool     iskick     ~%bool     isvalid ~%bool     isstuck ~%bool     isdribble~%char     current_role~%float32  role_time~%Point2d  target~% ~%~%================================================================================~%MSG: nubot_common/Angle~%float32 theta~%~%================================================================================~%MSG: nubot_common/BallInfo~%Header header~%int32     ballinfostate~%Point2d   pos~%PPoint    real_pos~%Point2d   velocity~%bool      pos_known~%bool      velocity_known~%~%~%================================================================================~%MSG: nubot_common/CoachInfo~%Header header~%char MatchMode~%char MatchType~%char TestMode           ~%Point2d pointA~%Point2d pointB~%int16 angleA~%int16 angleB~%char idA~%char idB~%char kickforce~%~%================================================================================~%MSG: nubot_common/PassCommands~%uint32  pass_id~%uint32  catch_id~%Point2d pass_pt~%Point2d catch_pt~%bool    is_passout~%bool    is_dynamic_pass~%bool    is_static_pass~%bool    is_valid~% ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WorldModelInfo)))
  "Returns full string definition for message of type 'WorldModelInfo"
  (cl:format cl:nil "Header header~%ObstaclesInfo obstacleinfo~%ObstaclesInfo oppinfo~%RobotInfo[]   robotinfo~%BallInfo[]    ballinfo~%CoachInfo     coachinfo~%PassCommands  pass_cmd~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: nubot_common/ObstaclesInfo~%Header header~%Point2d[] pos~%PPoint[] polar_pos~%~%~%================================================================================~%MSG: nubot_common/Point2d~%float32 x~%float32 y~%~%================================================================================~%MSG: nubot_common/PPoint~%float32 angle~%float32 radius~%~%================================================================================~%MSG: nubot_common/RobotInfo~%Header header~%int32    AgentID~%int32    targetNum1~%int32    targetNum2~%int32    targetNum3~%int32    targetNum4~%int32    staticpassNum~%int32    staticcatchNum~%Point2d  pos~%Angle    heading~%float32  vrot~%Point2d  vtrans~%bool     iskick     ~%bool     isvalid ~%bool     isstuck ~%bool     isdribble~%char     current_role~%float32  role_time~%Point2d  target~% ~%~%================================================================================~%MSG: nubot_common/Angle~%float32 theta~%~%================================================================================~%MSG: nubot_common/BallInfo~%Header header~%int32     ballinfostate~%Point2d   pos~%PPoint    real_pos~%Point2d   velocity~%bool      pos_known~%bool      velocity_known~%~%~%================================================================================~%MSG: nubot_common/CoachInfo~%Header header~%char MatchMode~%char MatchType~%char TestMode           ~%Point2d pointA~%Point2d pointB~%int16 angleA~%int16 angleB~%char idA~%char idB~%char kickforce~%~%================================================================================~%MSG: nubot_common/PassCommands~%uint32  pass_id~%uint32  catch_id~%Point2d pass_pt~%Point2d catch_pt~%bool    is_passout~%bool    is_dynamic_pass~%bool    is_static_pass~%bool    is_valid~% ~%~%~%"))
