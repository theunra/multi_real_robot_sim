...
if("TRUE" STREQUAL "TRUE")
  set(nubot_common_SOURCE_PREFIX /home/theunra/multi_real_robot_sim/src/nubot_common)
  set(nubot_common_DEVEL_PREFIX /home/theunra/multi_real_robot_sim/devel)
  ...
  set(nubot_common_INSTALL_PREFIX /home/theunra/multi_real_robot_sim/install)
...
if(NOT "/home/theunra/multi_real_robot_sim/devel/include;/opt/ros/noetic/include;/opt/ros/noetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include;/home/theunra/multi_real_robot_sim/src/nubot_common/core/include " STREQUAL " ")
  set(nubot_common_INCLUDE_DIRS "")
  set(_include_dirs "/home/theunra/multi_real_robot_sim/devel/include;/opt/ros/noetic/include;/opt/ros/noetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include;/home/theunra/multi_real_robot_sim/src/nubot_common/core/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nubot_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/theunra/multi_real_robot_sim/src/nubot_common/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT nubot_common_NUM_DUMMY_TARGETS)
      set(nubot_common_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::nubot_common::wrapped-linker-option${nubot_common_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR nubot_common_NUM_DUMMY_TARGETS "${nubot_common_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::nubot_common::wrapped-linker-option${nubot_common_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND nubot_common_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/theunra/multi_real_robot_sim/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(nubot_common_EXPORTED_TARGETS ${${nubot_common_dep}_EXPORTED_TARGETS})
endforeach()
